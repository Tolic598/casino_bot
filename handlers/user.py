...
#     data = state.get_data()
#     print(data.get("suma"))
#     await message.answer("Бот подбирает провайдер и слоты которые играеют 1", reply_markup=slots)
#     await state.clear()
    
#3 Oaks Gaming
@router.callback_query(F.data == 'btn1')
async def btn1(call: types.CallbackQuery):
...
async def btn2(call: types.CallbackQuery):
...
async def btn3(call: types.CallbackQuery):
...
async def btn4(call: types.CallbackQuery):
...
async def btn5(call: types.CallbackQuery):
...
async def btn6(call: types.CallbackQuery):
...
async def btn7(call: types.CallbackQuery):
...
async def btn8(call: types.CallbackQuery):
...
async def btn9(call: types.CallbackQuery):
...
async def btn10(call: types.CallbackQuery):
...
async def btn11(call: types.CallbackQuery):
...
async def btn12(call: types.CallbackQuery):
...
async def btn13(call: types.CallbackQuery):
...
async def btn14(call: types.CallbackQuery):
...
async def btn15(call: types.CallbackQuery):
...
async def btn16(call: types.CallbackQuery):
